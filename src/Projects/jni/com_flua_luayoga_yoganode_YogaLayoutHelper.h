...
#include <jni.h>
/* Header for class com_flua_luayoga_yoganode_YogaLayoutHelper */
#ifndef _Included_com_flua_luayoga_yoganode_YogaLayoutHelper
#define _Included_com_flua_luayoga_yoganode_YogaLayoutHelper
